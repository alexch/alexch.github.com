...
class Iconistan < Erector::Widget
  extend Rounded
  external :style, <<-CSS
  div.iconistan { position: relative; padding: 2px; margin: 2px; }
  ...
  div.iconistan div.icon div.url { position: absolute; top: 36px; left: 2px; }  /* must sync url's left and iconistan's padding */
